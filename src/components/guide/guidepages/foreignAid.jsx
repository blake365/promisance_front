...
export default function AidGuide({ empire })
{
    ...
    const { aidDelay, aidMaxCredits } = useSelector((state) => state.games.activeGame)

    return (
        <div>
            <GuideLink text='Return to Index' page='Index' />
            <h2>Sending Foreign Aid</h2>
            <p>If one of your friends or clan mates is in trouble and needs help, you can send some of your {eraArray[empire.era].trpsea} with a shipment of troops and supplies. Up to {aidMaxCredits} can be sent at any given time, and one additional shipment can be sent every {aidDelay / 60 / 60} hours.</p>
