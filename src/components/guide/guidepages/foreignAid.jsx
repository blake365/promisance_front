...
export default function AidGuide({ empire })
{
    return (
        <div>
            ...
            <p>In a single aid shipment, you can send up to 20% of your empire's currently available troops, money, {eraArray[empire.era].runes}, and {eraArray[empire.era].food} to another empire.</p>
