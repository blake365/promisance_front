...
export default function ScoresGuide({ empire })
{
    return (
        <div>
            ...
            <dl>
                <dt><span className="mprotected">Protected</span></dt>
                ...
                <dt><span className="mdead">Dead</span></dt>
                ...
                <dt><span className="mself">Yourself</span></dt>
