...
{
    const { turnsMax, turnsProtection } = useSelector((state) => state.games.activeGame)
    ...
    return (
        <div>
            ...
            <p>Your empire is protected until you have used {turnsProtection} turns. You cannot attack nor be attacked during this time. </p>
