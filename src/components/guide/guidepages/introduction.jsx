...
export default function IntroGuide({ empire })
{
    return (
        <div>
            ...
            <p>Each time you take a turn, your empire will collect taxes from its citizens and harvest food. Tax revenue will then be spent maintaining your empire and its military, and food will be used to feed your population. Be careful to not run out of money or food - while the <GuideLink page='The%20Bank' text='world bank' /> can help you with the former, the latter can have disastrous results.</p>
