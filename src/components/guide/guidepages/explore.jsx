...
export default function ExploreGuide()
{
    return (
        <div>
            ...
            <p>Be warned - as your empire grows larger, it will become more and more difficult to find usable land, at which point you will have to resort to <GuideLink text='attacking' page='Your Army' /> other empires to steal their land.</p>
        </div>
    )
}
