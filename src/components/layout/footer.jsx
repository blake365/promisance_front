        ...
        <div>
            <Container size='lg' py='lg'>
                <Group spacing={0} position="apart">
                    ...
                    <Group >
                        <Anchor color='dimmed' href='https://guide.neopromisance.com' target="_blank">Guide</Anchor>
                        <Anchor component={Link} to='/rules' color='dimmed'>Rules</Anchor>
                        <Anchor component={Link} to='/privacy' color='dimmed'>Privacy Policy</Anchor>
                        <Anchor component='a' href='https://www.buymeacoffee.com/blakemorgan' target='_blank' color='dimmed'>Donate</Anchor>
