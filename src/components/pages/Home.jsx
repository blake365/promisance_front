import { Card, Group, Box, Title, Text, Button, Center, Badge, Container, Flex, Grid } from '@mantine/core'
                ...
                <Box>
                    ...
                    <Group spacing='sm' position='center' >
                        <Card ta='left' w={350} mih={440} withBorder>
                            <Card.Section>
                                <img src='/images/farm.webp' alt='farm' height={200} loading='lazy' />
                            </Card.Section>
                        ...
                        <Card ta='left' w={350} mih={440} withBorder>
                            <Card.Section>
                                <img src='/images/cash.webp' alt='farm' height={200} loading='lazy' />
                            </Card.Section>
                    ...
                    <Group spacing='sm' position='center' mt='sm'>
                        <Card ta='left' w={350} mih={440} withBorder>
                            <Card.Section>
                                <img src='/images/industry.webp' alt='farm' height={200} loading='lazy' />
                            </Card.Section>
                        ...
                        <Card ta='left' w={350} mih={440} withBorder>
                            <Card.Section>
                                <img src='/images/magic.webp' alt='farm' height={200} loading='lazy' />
                            </Card.Section>
