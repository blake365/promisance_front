import { Card, Grid, Stack, Table, Title, Group, Text, Avatar, Modal } from '@mantine/core'
...
export default function Summary()
{
	...
	useEffect(() =>
	{
		...
		if (empire && time && time - new Date(empire.createdAt).getTime() <= 300000) {
