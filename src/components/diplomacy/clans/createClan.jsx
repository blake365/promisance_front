    ...
    return (
        <Paper maw={400} p={20}>
            ...
            <form onSubmit={form.onSubmit((values) =>
                ...
                <Card >
                    {disabled && <Text align='center' color='red'>{t('diplomacy:clans.protectionDisabled')}</Text>}
                    <TextInput required label={t('diplomacy:clans.clanName')} placeholder={t('diplomacy:clans.namePlaceholder')} size="md" {...form.getInputProps('clanName')} />
